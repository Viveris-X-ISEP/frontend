...
describe('SurveyService', () => {
  ...
  describe('calculateEmissions', () => {
    it('should successfully calculate and save emissions', async () => {
      mockApi
        .onPost('/emissions/calculate', mockFootprintPayload)
        .reply(200, mockEmissionResponse);
    ...
    it('should throw an error when payload is invalid', async () => {
      ...
      await expect(
        SurveyService.calculateEmissions(mockFootprintPayload)
      ).rejects.toThrow();
    });
  ...
  describe('getLatestEmission', () => {
    it('should successfully get latest emission for user', async () => {
      mockApi
        .onGet(`/emissions/user/${mockUserId}`)
        .reply(200, mockEmissionResponse);
  ...
  describe('getAllEmissions', () => {
    ...
    it('should successfully get all emissions for user', async () => {
      mockApi
        .onGet(`/emissions/all/user/${mockUserId}`)
        .reply(200, mockEmissionsArray);
  ...
  describe('getLatestApiEmission', () => {
    ...
    it('should successfully get latest API emission for user', async () => {
      mockApi
        .onGet(`/emissions/api/user/${mockUserId}`)
        .reply(200, mockApiEmission);
    ...
    it('should throw an error when no API emissions exist', async () => {
      ...
      await expect(
        SurveyService.getLatestApiEmission(mockUserId)
      ).rejects.toThrow();
    });
  });
  ...
  describe('getAllApiEmissions', () => {
    it('should successfully get all API emissions for user', async () => {
      const mockApiEmissions: UserEmissionDto[] = [
        { ...mockEmissionResponse, origin: 'API' },
      ];

      mockApi
        .onGet(`/emissions/all/api/user/${mockUserId}`)
        .reply(200, mockApiEmissions);
  ...
  describe('getLatestMissionEmission', () => {
    ...
    it('should successfully get latest mission emission for user', async () => {
      mockApi
        .onGet(`/emissions/missions/user/${mockUserId}`)
        .reply(200, mockMissionEmission);
    ...
    it('should throw an error when no mission emissions exist', async () => {
      ...
      await expect(
        SurveyService.getLatestMissionEmission(mockUserId)
      ).rejects.toThrow();
    });
  });
  ...
  describe('getAllMissionEmissions', () => {
    it('should successfully get all mission emissions for user', async () => {
      ...
      mockApi
        .onGet(`/emissions/all/missions/user/${mockUserId}`)
        .reply(200, mockMissionEmissions);
